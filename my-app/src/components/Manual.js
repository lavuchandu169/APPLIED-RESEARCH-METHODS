    ...
    if (Object.keys(validationErrors).length === 0) {
      try {
        ...
        const response = await axios.post(
          "http://localhost:5001/predict/combined",
          {
        ...
        datasets: [
          {
            ...
            data: [
              parseFloat(patientsLoad),
              parseFloat(staffAvailable),
              parseFloat(equipmentsInUse),
            ],
    ...
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          />
          {errors.patientsLoad && (
            <p className="text-red-500 text-xs mt-1">{errors.patientsLoad}</p>
          )}
        </div>
